...
namespace IIS.Kandidaty_na_rabotu_v_organizaciyu
{
    ...
    [View("ТЧРегРезультE", new string[] {
            ...
            "Сотрудники.ФИОСотр as \'Ф и о сотр\'"}, Hidden=new string[] {
            "Сотрудники.ФИОСотр"})]
    ...
    public class ТЧРегРезульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kandidaty_na_rabotu_v_organizaciyu.ИтогСобесед fИтогСобесед;
        
        private int fОценкаКандид;
        
        private string fКрКомИлиОбсРеш;
        
        private IIS.Kandidaty_na_rabotu_v_organizaciyu.Сотрудники fСотрудники;
        
        private IIS.Kandidaty_na_rabotu_v_organizaciyu.РегРезульт fРегРезульт;
        ...
        public virtual IIS.Kandidaty_na_rabotu_v_organizaciyu.ИтогСобесед ИтогСобесед
        {
            get
            {
                ...
                IIS.Kandidaty_na_rabotu_v_organizaciyu.ИтогСобесед result = this.fИтогСобесед;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.Kandidaty_na_rabotu_v_organizaciyu.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.Kandidaty_na_rabotu_v_organizaciyu.Сотрудники result = this.fСотрудники;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Kandidaty_na_rabotu_v_organizaciyu.РегРезульт.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РегРезульт"})]
        public virtual IIS.Kandidaty_na_rabotu_v_organizaciyu.РегРезульт РегРезульт
        {
            get
            {
                ...
                IIS.Kandidaty_na_rabotu_v_organizaciyu.РегРезульт result = this.fРегРезульт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧРегРезультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧРегРезультE", typeof(IIS.Kandidaty_na_rabotu_v_organizaciyu.ТЧРегРезульт));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧРегРезульт : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Kandidaty_na_rabotu_v_organizaciyu.DetailArrayOfТЧРегРезульт members)

        // *** End programmer edit section *** (IIS.Kandidaty_na_rabotu_v_organizaciyu.DetailArrayOfТЧРегРезульт members)
        ...
        /// </summary>
        public DetailArrayOfТЧРегРезульт(IIS.Kandidaty_na_rabotu_v_organizaciyu.РегРезульт fРегРезульт) : 
                base(typeof(ТЧРегРезульт), ((ICSSoft.STORMNET.DataObject)(fРегРезульт)))
        {
        }
        
        public IIS.Kandidaty_na_rabotu_v_organizaciyu.ТЧРегРезульт this[int index]
        {
            get
            {
                return ((IIS.Kandidaty_na_rabotu_v_organizaciyu.ТЧРегРезульт)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Kandidaty_na_rabotu_v_organizaciyu.ТЧРегРезульт dataobject)
        {
