...
namespace IIS.Kandidaty_na_rabotu_v_organizaciyu
{
    ...
    [View("РегистАнкетыE", new string[] {
            ...
            "ВакантДолжн as \'Вакант должн\'",
            "ВакантДолжн.Должность as \'Должность\'"}, Hidden=new string[] {
    ...
    public class РегистАнкеты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kandidaty_na_rabotu_v_organizaciyu.ВакантДолжн fВакантДолжн;
        ...
        [PropertyStorage(new string[] {
                "ВакантДолжн"})]
        [NotNull()]
        public virtual IIS.Kandidaty_na_rabotu_v_organizaciyu.ВакантДолжн ВакантДолжн
        {
            get
            {
                ...
                IIS.Kandidaty_na_rabotu_v_organizaciyu.ВакантДолжн result = this.fВакантДолжн;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыE", typeof(IIS.Kandidaty_na_rabotu_v_organizaciyu.РегистАнкеты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыL", typeof(IIS.Kandidaty_na_rabotu_v_organizaciyu.РегистАнкеты));
                }
            }
        }
    }
