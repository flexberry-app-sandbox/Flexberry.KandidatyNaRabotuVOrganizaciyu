...
namespace IIS.Kandidaty_na_rabotu_v_organizaciyu
{
    ...
    [View("ПланирСобесE", new string[] {
            ...
            "РегистАнкеты.ФИОКандид as \'Ф и о кандид\'"}, Hidden=new string[] {
    ...
    [View("ПланирСобесL", new string[] {
            ...
            "Этаж as \'Этаж\'",
            "Организация.Наименование as \'Наименование\'",
            "РегистАнкеты.ФИОКандид as \'Ф и о кандид\'"})]
    public class ПланирСобес : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kandidaty_na_rabotu_v_organizaciyu.РегистАнкеты fРегистАнкеты;
        ...
        [PropertyStorage(new string[] {
                "РегистАнкеты"})]
        [NotNull()]
        public virtual IIS.Kandidaty_na_rabotu_v_organizaciyu.РегистАнкеты РегистАнкеты
        {
            get
            {
                ...
                IIS.Kandidaty_na_rabotu_v_organizaciyu.РегистАнкеты result = this.fРегистАнкеты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланирСобесE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесE", typeof(IIS.Kandidaty_na_rabotu_v_organizaciyu.ПланирСобес));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланирСобесL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесL", typeof(IIS.Kandidaty_na_rabotu_v_organizaciyu.ПланирСобес));
                }
            }
        }
    }
