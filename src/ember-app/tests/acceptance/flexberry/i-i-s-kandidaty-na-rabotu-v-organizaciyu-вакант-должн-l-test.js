...
moduleForAcceptance('[AGAT] Acceptance | i i s kandidaty na rabotu v organizaciyu вакант должн l');

test('testing i-i-s-kandidaty-na-rabotu-v-organizaciyu-вакант-должн-l', function(assert) {
