...
moduleForAcceptance('[AGAT] Acceptance | i i s kandidaty na rabotu v organizaciyu регист анкеты l');

test('testing i-i-s-kandidaty-na-rabotu-v-organizaciyu-регист-анкеты-l', function(assert) {
