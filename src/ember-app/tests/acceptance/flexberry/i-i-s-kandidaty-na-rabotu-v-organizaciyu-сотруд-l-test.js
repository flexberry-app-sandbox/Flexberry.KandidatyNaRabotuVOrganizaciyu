...
moduleForAcceptance('[AGAT] Acceptance | i i s kandidaty na rabotu v organizaciyu сотруд l');

test('testing i-i-s-kandidaty-na-rabotu-v-organizaciyu-сотруд-l', function(assert) {
